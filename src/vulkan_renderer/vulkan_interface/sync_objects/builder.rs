...
use crate::utils::{TakeVec, Result};
...
impl<'a> SyncObjectsBuilder<'a> {
    ...
    pub unsafe fn create_image_available_semaphores(mut self,
    ...
    pub unsafe fn create_render_finished_semaphores(mut self,
                                                    nb_of_frames_in_flight: u32)
                                                    -> Result<Self> {
        let semaphore_create_info = vk::SemaphoreCreateInfo::default();
        for _ in 0..nb_of_frames_in_flight {
    ...
    pub unsafe fn create_in_flight_fences(mut self,
                                          nb_of_frames_in_flight: u32)
                                          -> Result<Self> {
